"""
Esquemas de formularios estructurados por tipo de material.
El agente devuelve un formulario en vez de pedir datos por chat libre.
El frontend renderiza los campos según el tipo de material.

Ventajas:
- Evita errores de tipeo y ambigüedad
- Reduce la carga conversacional (menos tokens)
- Mejora UX (selects, validación, placeholders)
- Datos limpios directo a la BD
"""
import json
from pathlib import Path

# ── Catálogo de materiales con clasificación orgánico/inorgánico ───────────
MATERIALES_CATALOGO = {
    "textil": {
        "label": "Textil",
        "clasificacion": "inorganico",
        "icono": "👕",
    },
    "vidrio": {
        "label": "Vidrio",
...
FORMULARIOS = {
            ...
            * _campos_comunes(),
            {
                ...
                "type": "textarea",
                "placeholder": "Ej: Ropa de invierno, ropa infantil, etc.",
                "required": False,
            },
        ],
    },
    ...
    "vidrio": {
        ...
        "campos": [
            ...
            {
                "name": "separacion_color",
                "label": "Separación por color",
                "type": "select",
                "options": [
    ...
    "escombros": {
        ...
        "campos": [
            {
                "name": "volumen",
                "label": "¿Cuál es el volumen aproximado?",
                "type": "number",
                "unit": "m³",
                "placeholder": "Ej: 15",
                "required": True,
    ...
    "organico": {
        ...
        "campos": [
            ...
            {
                "name": "subtipo_organico",
                "label": "Tipo de residuo orgánico",
                "type": "select",
                "options": [
...
# ── Formulario de selección de material (pantalla inicial) ─────────────────
FORMULARIO_INICIAL = {
...
def validar_formulario(material: str, datos: dict) -> dict:
    """
    Valida que los datos del formulario tengan todos los campos requeridos.
    Retorna {"ok": True, "data": {...}} o {"ok": False, "errors": [...]}.
    """
